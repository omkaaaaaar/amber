/* =====================================================================
   SITE CONFIG
   Everything you'll want to personalize across the whole site lives here.
   This file is shared by every page, so edit it once and it applies
   everywhere.
   ===================================================================== */
const CONFIG = {
  herName: "Amber",
  ...
  // Polaroids: put image files named 1.jpg ... 16.jpg inside the "photos"
  // folder next to this file. If a file is missing, a placeholder shows
  ...
  countdownTeaser: "Somewhere past this countdown, a handful of lines are waiting for you \u2014 open the Love Notes page whenever you're ready.",

  // Love Notes page — six original lines revealed by tapping a seal.
